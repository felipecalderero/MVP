...
const CoursePanel = ({course, fullScreenActive, section, setSection, selectedKeys, setSelectedKeys}:{course: UserCourse | null; fullScreenActive:boolean; section:SectionObjectFormat | null, setSection:Dispatch<SetStateAction<SectionObjectFormat | null>>, selectedKeys:Set<string>, setSelectedKeys:any}) => {
  ...
  return ( 
    <div className={`w-full ${fullScreenActive ? "w-[0px]" : "w-[350px]"} h-full bg-[#F2F3F5] overflow-y-auto transition-all duration-300`}>
        {/* Intro */}
        <div className="flex items-start justify-center flex-col w-full p-3.5 bg-white shadow-md">
        ...
        {/* Search */}
        <div className="myFlex flex-col w-full bg-[#F2F3F5] my-2.5">
          {/* Input alike */}
          <div 
          ...
          <div className={`${!openDrop ? "hidden" : "flex"} relative flex-col items-center justify-start w-full bg-white rounded-b-[4px] border-[0.5px] border-t-none border-[#CACCD6] pt-3`}>
            ...
            <div className="px-3 myFlex w-full">
              <div className="myFlex gap-x-2.5 w-full px-2 pb-1.5 pt-1.5 rounded-[4px] border-[0.5px] border-[#CACCD6] ring-1 ring-transparent focus-within:border-black focus-within:ring-black">
                ...
                <input type="text" className="text-[11px] tracking-wide flex flex-1 focus:border-none focus:outline-none" />
              </div>
            </div>
        ...
        {/* Accordion */}
        <div className="w-full h-fit flex items-start justify-center my-2.5 bg-[#F2F3F5]">
        {course && section && (
          <Accordion 
                  ...
                  {step.list.map((each, _)=> (
                    ...
                    >
                      ...
                      <div className="myFlex flex-col gap-y-1 z-20">
                        {each.completed ? (
                          <IoIosCheckmarkCircle className="w-[16px] h-[16px] text-[#1f1f1f]"/>
                          ):(
                      ...
                      {/* Content */}
                      <div className="z-20 flex items-start justify-center flex-col gap-y-1 -mt-[2.5px]">
                        {/* Title */}
